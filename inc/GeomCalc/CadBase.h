...
void AFX_EXT_API RotatePoint(VECTOR3D bv, double angle, CPoint3D pt_ref, CPoint3D& pt);
void AFX_EXT_API RotateVector(VECTOR3D bv, double angle, CVector3D& vec);

void AFX_EXT_API ScalePoint(CPoint3D pt_ref, CPoint3D& pt, double fx, double fy, double fz);
